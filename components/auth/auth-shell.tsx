      ...
      <div className="grid w-full max-w-5xl gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <div className="hidden lg:flex flex-col gap-10">
          <div className="flex items-center gap-2">
            <div className="h-10 w-10 rounded-xl bg-brand-primary flex items-center justify-center text-white font-black text-2xl">C</div>
          ...
          <div className="space-y-6">
            <h1 className="text-5xl font-black tracking-tightest text-slate-950 leading-[1.1]">
              The premium hub for <span className="text-brand-primary">Malta careers.</span>
            </h1>
          ...
          <ul className="space-y-4">
            {benefits.map((benefit, i) => (
              <li key={i} className="flex items-center gap-3 text-sm font-bold text-slate-600 uppercase tracking-widest">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-brand-success/10 text-brand-success">
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-premium lg:p-10">
            <div className="lg:hidden flex items-center gap-2 mb-8 justify-center">
              <div className="h-8 w-8 rounded-lg bg-brand-primary flex items-center justify-center text-white font-black text-xl">C</div>
