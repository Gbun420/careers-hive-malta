        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col items-start text-left">
            ...
            <p className="mt-8 max-w-lg text-lg font-medium leading-relaxed text-muted-foreground">
              The premium job board for the Maltese market. Get real-time alerts from <span className="text-foreground font-bold">{publicMetricsEnabled ? `${verifiedEmployers} verified employers` : "Verified Employers"}</span> delivered with zero latency.
            </p>
            
            <div className="mt-10 flex flex-wrap gap-4">
              <Button asChild size="lg" className="rounded-2xl h-14 px-8 shadow-lg">
                <Link href="/signup">Create Free Account</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="rounded-2xl h-14 px-8 hover:bg-muted transition-all">
          ...
          <div className="relative">
            ...
            <div className="rounded-[2.5rem] border border-border bg-card p-8 shadow-premium lg:p-10">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Active Professionals</div>
                    <div className="text-4xl font-black tabular-nums tracking-tightest text-foreground">{activeSeekers}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Maltese Opportunities</div>
                    <div className="text-4xl font-black tabular-nums tracking-tightest text-foreground">{totalJobs}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Verified Brands</div>
                    <div className="text-4xl font-black tabular-nums tracking-tightest text-foreground">{verifiedEmployers}</div>
                  </div>
                </div>
              </div>
